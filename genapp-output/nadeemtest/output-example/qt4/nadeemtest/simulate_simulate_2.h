...
void nadeemtest::readyReadStandardOutput_simulate_simulate_2()
{
   process_json[ "simulate_2" ] += QString( process_simulate_simulate_2->readAllStandardOutput() );
}

void nadeemtest::readyReadStandardError_simulate_simulate_2()
{
   qDebug() << process_simulate_simulate_2->readAllStandardError();
}

void nadeemtest::error_simulate_simulate_2( QProcess::ProcessError e )
{
   qDebug() << "process_simulate_simulate_2->error()" << e;
}

void nadeemtest::finished_simulate_simulate_2( int, QProcess::ExitStatus )
{
   qDebug() << "process_simulate_simulate_2->finished()";
