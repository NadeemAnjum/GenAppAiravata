void nadeemtest::module_load_analyze_analyze_2()
{
...
void nadeemtest::module_reset_analyze_analyze_2()
{
   reset_default_values();
}

void nadeemtest::module_submit_analyze_analyze_2()
{
   save_last_values();
   ...
   QString program = "/home/nadeem/nadeemtest/bin/analyze_2";
   ...
   process_json[ "analyze_2" ] = qoutput;
...
void nadeemtest::readyReadStandardOutput_analyze_analyze_2()
{
   process_json[ "analyze_2" ] += QString( process_analyze_analyze_2->readAllStandardOutput() );
}

void nadeemtest::readyReadStandardError_analyze_analyze_2()
{
   qDebug() << process_analyze_analyze_2->readAllStandardError();
}

void nadeemtest::error_analyze_analyze_2( QProcess::ProcessError e )
{
   qDebug() << "process_analyze_analyze_2->error()" << e;
}

void nadeemtest::finished_analyze_analyze_2( int, QProcess::ExitStatus )
{
   qDebug() << "process_analyze_analyze_2->finished()";
