void nadeemtest::module_load_analyze_analyze_1()
{
...
void nadeemtest::module_reset_analyze_analyze_1()
{
   reset_default_values();
}

void nadeemtest::module_submit_analyze_analyze_1()
{
   save_last_values();
   ...
   QString program = "/home/nadeem/nadeemtest/bin/analyze_1";
   ...
   process_json[ "analyze_1" ] = qoutput;
...
void nadeemtest::readyReadStandardOutput_analyze_analyze_1()
{
   process_json[ "analyze_1" ] += QString( process_analyze_analyze_1->readAllStandardOutput() );
}

void nadeemtest::readyReadStandardError_analyze_analyze_1()
{
   qDebug() << process_analyze_analyze_1->readAllStandardError();
}

void nadeemtest::error_analyze_analyze_1( QProcess::ProcessError e )
{
   qDebug() << "process_analyze_analyze_1->error()" << e;
}

void nadeemtest::finished_analyze_analyze_1( int, QProcess::ExitStatus )
{
   qDebug() << "process_analyze_analyze_1->finished()";
