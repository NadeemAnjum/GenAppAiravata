void nadeemtest::module_load_interact_interact_2()
{
...
void nadeemtest::module_reset_interact_interact_2()
{
   reset_default_values();
}

void nadeemtest::module_submit_interact_interact_2()
{
   save_last_values();
   ...
   QString program = "/home/nadeem/nadeemtest/bin/interact_2";
   ...
   process_json[ "interact_2" ] = qoutput;
...
void nadeemtest::readyReadStandardOutput_interact_interact_2()
{
   process_json[ "interact_2" ] += QString( process_interact_interact_2->readAllStandardOutput() );
}

void nadeemtest::readyReadStandardError_interact_interact_2()
{
   qDebug() << process_interact_interact_2->readAllStandardError();
}

void nadeemtest::error_interact_interact_2( QProcess::ProcessError e )
{
   qDebug() << "process_interact_interact_2->error()" << e;
}

void nadeemtest::finished_interact_interact_2( int, QProcess::ExitStatus )
{
   qDebug() << "process_interact_interact_2->finished()";
