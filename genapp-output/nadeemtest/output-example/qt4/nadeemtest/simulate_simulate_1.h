void nadeemtest::module_load_simulate_simulate_1()
{
...
void nadeemtest::module_reset_simulate_simulate_1()
{
   reset_default_values();
}

void nadeemtest::module_submit_simulate_simulate_1()
{
   save_last_values();
   ...
   QString program = "/home/nadeem/nadeemtest/bin/simulate_1";
   ...
   process_json[ "simulate_1" ] = "";
   qDebug() << "process started";
   string tprojId = createProject("nadeem", "simulate_1");
   ...
   string texpId = createExperiment("nadeem", "exp1", projId, "simulate_1", json);	
...
void nadeemtest::readyReadStandardOutput_simulate_simulate_1()
{
   process_json[ "simulate_1" ] += QString( process_simulate_simulate_1->readAllStandardOutput() );
}

void nadeemtest::readyReadStandardError_simulate_simulate_1()
{
   qDebug() << process_simulate_simulate_1->readAllStandardError();
}

void nadeemtest::error_simulate_simulate_1( QProcess::ProcessError e )
{
   qDebug() << "process_simulate_simulate_1->error()" << e;
}

void nadeemtest::finished_simulate_simulate_1( int, QProcess::ExitStatus )
{
   qDebug() << "process_simulate_simulate_1->finished()";
