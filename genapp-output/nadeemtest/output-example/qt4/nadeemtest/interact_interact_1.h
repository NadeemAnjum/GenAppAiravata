void nadeemtest::module_load_interact_interact_1()
{
...
void nadeemtest::module_reset_interact_interact_1()
{
   reset_default_values();
}

void nadeemtest::module_submit_interact_interact_1()
{
   save_last_values();
   ...
   QString program = "/home/nadeem/nadeemtest/bin/interact_1";
   ...
   process_json[ "interact_1" ] = "";
   qDebug() << "process started";
   string tprojId = createProject("nadeem", "interact_1");
   ...
   string texpId = createExperiment("nadeem", "exp1", projId, "interact_1", json);	
...
void nadeemtest::readyReadStandardOutput_interact_interact_1()
{
   process_json[ "interact_1" ] += QString( process_interact_interact_1->readAllStandardOutput() );
}

void nadeemtest::readyReadStandardError_interact_interact_1()
{
   qDebug() << process_interact_interact_1->readAllStandardError();
}

void nadeemtest::error_interact_interact_1( QProcess::ProcessError e )
{
   qDebug() << "process_interact_interact_1->error()" << e;
}

void nadeemtest::finished_interact_interact_1( int, QProcess::ExitStatus )
{
   qDebug() << "process_interact_interact_1->finished()";
