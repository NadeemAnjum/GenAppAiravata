void nadeemtest::module_load_build_build_2()
{
...
void nadeemtest::module_reset_build_build_2()
{
   reset_default_values();
}

void nadeemtest::module_submit_build_build_2()
{
   save_last_values();
   ...
   QString program = "/home/nadeem/nadeemtest/bin/build_2";
...
void nadeemtest::readyReadStandardOutput_build_build_2()
{
   process_json[ "build_2" ] += QString( process_build_build_2->readAllStandardOutput() );
}

void nadeemtest::readyReadStandardError_build_build_2()
{
   qDebug() << process_build_build_2->readAllStandardError();
}

void nadeemtest::error_build_build_2( QProcess::ProcessError e )
{
   qDebug() << "process_build_build_2->error()" << e;
}

void nadeemtest::finished_build_build_2( int, QProcess::ExitStatus )
{
   qDebug() << "process_build_build_2->finished()";
