...
void nadeemtest::readyReadStandardOutput_calculate_calculate_1()
{
   process_json[ "calculate_1" ] += QString( process_calculate_calculate_1->readAllStandardOutput() );
}

void nadeemtest::readyReadStandardError_calculate_calculate_1()
{
   qDebug() << process_calculate_calculate_1->readAllStandardError();
}

void nadeemtest::error_calculate_calculate_1( QProcess::ProcessError e )
{
   qDebug() << "process_calculate_calculate_1->error()" << e;
}

void nadeemtest::finished_calculate_calculate_1( int, QProcess::ExitStatus )
{
   qDebug() << "process_calculate_calculate_1->finished()";
