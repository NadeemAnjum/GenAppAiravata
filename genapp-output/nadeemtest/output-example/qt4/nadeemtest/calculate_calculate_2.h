void nadeemtest::module_load_calculate_calculate_2()
{
...
void nadeemtest::module_reset_calculate_calculate_2()
{
   reset_default_values();
}

void nadeemtest::module_submit_calculate_calculate_2()
{
   save_last_values();
   ...
   QString program = "/home/nadeem/nadeemtest/bin/calculate_2";
   ...
   process_json[ "calculate_2" ] = "";
   qDebug() << "process started";
   string tprojId = createProject("nadeem", "calculate_2");
   ...
   string texpId = createExperiment("nadeem", "exp1", projId, "calculate_2", json);	
...
void nadeemtest::readyReadStandardOutput_calculate_calculate_2()
{
   process_json[ "calculate_2" ] += QString( process_calculate_calculate_2->readAllStandardOutput() );
}

void nadeemtest::readyReadStandardError_calculate_calculate_2()
{
   qDebug() << process_calculate_calculate_2->readAllStandardError();
}

void nadeemtest::error_calculate_calculate_2( QProcess::ProcessError e )
{
   qDebug() << "process_calculate_calculate_2->error()" << e;
}

void nadeemtest::finished_calculate_calculate_2( int, QProcess::ExitStatus )
{
   qDebug() << "process_calculate_calculate_2->finished()";
