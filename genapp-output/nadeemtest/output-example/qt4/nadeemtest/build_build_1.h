...
void nadeemtest::readyReadStandardOutput_build_build_1()
{
   process_json[ "build_1" ] += QString( process_build_build_1->readAllStandardOutput() );
}

void nadeemtest::readyReadStandardError_build_build_1()
{
   qDebug() << process_build_build_1->readAllStandardError();
}

void nadeemtest::error_build_build_1( QProcess::ProcessError e )
{
   qDebug() << "process_build_build_1->error()" << e;
}

void nadeemtest::finished_build_build_1( int, QProcess::ExitStatus )
{
   qDebug() << "process_build_build_1->finished()";
