void nadeemtest::module_load_tools_align()
{
...
void nadeemtest::module_reset_tools_align()
{
   reset_default_values();
}

void nadeemtest::module_submit_tools_align()
{
   save_last_values();
   ...
   QString program = "/home/nadeem/nadeemtest/bin/align";
   ...
   process_json[ "align" ] = "";
   qDebug() << "process started";
   string tprojId = createProject("nadeem", "align");
   ...
   string texpId = createExperiment("nadeem", "exp1", projId, "align", json);	
...
void nadeemtest::readyReadStandardOutput_tools_align()
{
   process_json[ "align" ] += QString( process_tools_align->readAllStandardOutput() );
}

void nadeemtest::readyReadStandardError_tools_align()
{
   qDebug() << process_tools_align->readAllStandardError();
}

void nadeemtest::error_tools_align( QProcess::ProcessError e )
{
   qDebug() << "process_tools_align->error()" << e;
}

void nadeemtest::finished_tools_align( int, QProcess::ExitStatus )
{
   qDebug() << "process_tools_align->finished()";
