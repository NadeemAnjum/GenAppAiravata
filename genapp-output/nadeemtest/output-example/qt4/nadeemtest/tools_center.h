...
void nadeemtest::readyReadStandardOutput_tools_center()
{
   process_json[ "center" ] += QString( process_tools_center->readAllStandardOutput() );
}

void nadeemtest::readyReadStandardError_tools_center()
{
   qDebug() << process_tools_center->readAllStandardError();
}

void nadeemtest::error_tools_center( QProcess::ProcessError e )
{
   qDebug() << "process_tools_center->error()" << e;
}

void nadeemtest::finished_tools_center( int, QProcess::ExitStatus )
{
   qDebug() << "process_tools_center->finished()";
