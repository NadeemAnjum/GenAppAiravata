...
$cmd = "/home/nadeem/nadeemtest/bin/build_2";
...
if ( sizeof( $_REQUEST ) )
{
	...
	$projId=createProject("nadeem", "build_2");
	$expId=createExperiment("nadeem", "exp1", $projId, "build_2", $json);	
