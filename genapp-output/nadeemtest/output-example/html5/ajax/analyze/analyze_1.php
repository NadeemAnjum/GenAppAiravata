...
// error_log( "analyze_1:\t", 3, "/tmp/mylog" );
...
$cmd = "/home/nadeem/nadeemtest/bin/analyze_1";
...
if ( sizeof( $_REQUEST ) )
{
    ...
    error_log( "\tcmd: <$cmd>\n", 3, "/tmp/mylog" );
		...
		$projId=createProject("nadeem", "analyze_1");
		$expId=createExperiment("nadeem", "exp1", $projId, "analyze_1", $json);	
