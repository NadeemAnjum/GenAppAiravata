...
// error_log( "data_interpolation:\t", 3, "/tmp/mylog" );
...
$cmd = "/home/nadeem/nadeemtest/bin/data_interpolation";
...
if ( sizeof( $_REQUEST ) )
{
	...
	$projId=createProject("nadeem", "data_interpolation");
	$expId=createExperiment("nadeem", "exp1", $projId, "data_interpolation", $json);	
