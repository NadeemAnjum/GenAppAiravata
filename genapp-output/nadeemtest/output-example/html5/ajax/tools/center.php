...
$cmd = "/home/nadeem/nadeemtest/bin/center";
...
if ( sizeof( $_REQUEST ) )
{
	...
	$projId=createProject("nadeem", "center");
	$expId=createExperiment("nadeem", "exp1", $projId, "center", $json);	
