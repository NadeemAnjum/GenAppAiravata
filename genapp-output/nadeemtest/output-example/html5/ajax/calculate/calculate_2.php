...
// error_log( "calculate_2:\t", 3, "/tmp/mylog" );
...
$cmd = "/home/nadeem/nadeemtest/bin/calculate_2";
...
if ( sizeof( $_REQUEST ) )
{
	...
	$projId=createProject("nadeem", "calculate_2");
	$expId=createExperiment("nadeem", "exp1", $projId, "calculate_2", $json);	
