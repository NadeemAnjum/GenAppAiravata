...
// error_log( "calculate_1:\t", 3, "/tmp/mylog" );
...
$cmd = "/home/nadeem/nadeemtest/bin/calculate_1";
...
if ( sizeof( $_REQUEST ) )
{
	...
	$projId=createProject("nadeem", "calculate_1");
	$expId=createExperiment("nadeem", "exp1", $projId, "calculate_1", $json);	
