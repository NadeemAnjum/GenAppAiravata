...
// error_log( "simulate_2:\t", 3, "/tmp/mylog" );
...
$cmd = "/home/nadeem/nadeemtest/bin/simulate_2";
...
if ( sizeof( $_REQUEST ) )
{
	...
	$projId=createProject("nadeem", "simulate_2");
	$expId=createExperiment("nadeem", "exp1", $projId, "simulate_2", $json);	
