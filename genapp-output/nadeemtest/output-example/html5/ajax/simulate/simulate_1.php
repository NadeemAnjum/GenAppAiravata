...
// error_log( "simulate_1:\t", 3, "/tmp/mylog" );
...
$cmd = "/home/nadeem/nadeemtest/bin/simulate_1";
...
if ( sizeof( $_REQUEST ) )
{
	...
	$projId=createProject("nadeem", "simulate_1");
	$expId=createExperiment("nadeem", "exp1", $projId, "simulate_1", $json);	
