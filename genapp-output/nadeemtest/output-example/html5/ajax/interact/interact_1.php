...
// error_log( "interact_1:\t", 3, "/tmp/mylog" );
...
$cmd = "/home/nadeem/nadeemtest/bin/interact_1";
...
if ( sizeof( $_REQUEST ) )
{
    ...
    error_log( "\tcmd: <$cmd>\n", 3, "/tmp/mylog" );
		...
		$projId=createProject("nadeem", "interact_1");
		$expId=createExperiment("nadeem", "exp1", $projId, "interact_1", $json);	
