...
// error_log( "interact_2:\t", 3, "/tmp/mylog" );
...
$cmd = "/home/nadeem/nadeemtest/bin/interact_2";
...
if ( sizeof( $_REQUEST ) )
{
	...
	$projId=createProject("nadeem", "interact_2");
	$expId=createExperiment("nadeem", "exp1", $projId, "interact_2", $json);	
